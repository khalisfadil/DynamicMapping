 ...
 *
 *         void OutputDynamicMapping(uint32 u1, single u2[128*1024][3], single u3[128*1024][1],single u4[128*1024][1], single u5[128*1024][1],double u6[3][1], uint32 u7, double u8, double u9, double u10[3][1],double u11, int32 u12, int32 u13, double u14, double u15, double u16, double u17,double u18, double u19, double u20,double y1[128*1024*10][3], uint32 y2, double y3[128*1024][3], uint32 y4,int32 y5[128*1024*10][3], int32 y6[128*1024*10][3], int32 y7[128*1024*10][3],int32 y8[128*1024*10][3], int32 y9[128*1024][3])
 *
 *    Simulink version           : 23.2 (R2023b) 01-Aug-2023
 *    C++ source code generated on : 14-Nov-2024 17:39:59
 *
...
/**
     ...
     def.OutputFcnSpec = 'void OutputDynamicMapping(uint32 u1, single u2[128*1024][3], single u3[128*1024][1],single u4[128*1024][1], single u5[128*1024][1],double u6[3][1], uint32 u7, double u8, double u9, double u10[3][1],double u11, int32 u12, int32 u13, double u14, double u15, double u16, double u17,double u18, double u19, double u20,double y1[128*1024*10][3], uint32 y2, double y3[128*1024][3], uint32 y4,int32 y5[128*1024*10][3], int32 y6[128*1024*10][3], int32 y7[128*1024*10][3],int32 y8[128*1024*10][3], int32 y9[128*1024][3])';
